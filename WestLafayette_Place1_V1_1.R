...
indice_base_partial <- which((temp.patch.2.nonground[, 2]>=region[i, 2]))
...
temp.patch.2.fix.indice <- house_center_clean(temp.patch.2.house.center, k=7, p=0.2)
...
indice_base_partial_fix_1 <- which((temp.patch.2.nonground[, 1]>=region[i, 3]+410)&(temp.patch.2.nonground[, 1]<=region[i, 3]+440)
                                   &(temp.patch.2.nonground[, 2]>=region[i, 2]+330)&(temp.patch.2.nonground[, 2]<=region[i, 4]+320))
temp.patch.2.center.label[indice_base_partial_fix_1] <- FALSE
...
temp.patch.2.edge.1 <- relabel_roof_edges_1(temp.patch.2.nonground.partial, temp.patch.2.center.label, GMM_cluster_whole_1_4$Hessg, k=200, radius=10, metric_threshold=1.5)
temp.patch.2.edge.3 <- relabel_roof_edges_2(temp.patch.2.nonground.partial, temp.patch.2.center.label, GMM_cluster_whole_1_4$Hessg, height.patch.2.nonground.partial,
                                            k=200, radius=10, metric_threshold=1.5, height_threshold=5)
tt7 <- Sys.time()
...
tt8 <- Sys.time()
difftime(tt8, tt7, units="mins")
temp.patch.2.edge.2 <- relabel_roof_edges_1(temp.patch.2.nonground.partial, temp.patch.2.center.label, GMM_cluster_whole_1_5$Hessg, k=200, radius=10, metric_threshold=1.5)
...
plot3d(temp.patch.2.nonground.partial, aspect=c(1, 1, 0.1), col=label_to_color_1[GMM_cluster_fix_1_4_label], decorate=(box=FALSE))
...
plot3d(temp.patch.2.nonground.partial, aspect=c(1, 1, 0.1), col=label_to_color_1[GMM_cluster_fix_1_5_label], decorate=(box=FALSE))
...
text3.1 <- "Results/4/WestLafayette_City_region1_h(1,4)_Result_sectored_kernel.rds"
text3.2 <- "Results/4/WestLafayette_City_region1_h(1,4)_Result_kernel.rds"
text3.3 <- "Results/4/WestLafayette_City_region1_h(1,4)_Result_sectored_kernel_and_height.rds"
text3.4 <- "Results/4/WestLafayette_City_region1_h(1,4)_Result_kernel_and_height.rds"
text3.5 <- "Results/4/WestLafayette_City_region1_h(1,4)_Result_sectored_kernel_and_intensity.rds"
text3.6 <- "Results/4/WestLafayette_City_region1_h(1,4)_Result_kernel_and_intensity.rds"
text3.7 <- "Results/4/WestLafayette_City_region1_h(1,4)_Result_sectored_kernel_and_height_and_intensity.rds"
text3.8 <- "Results/4/WestLafayette_City_region1_h(1,4)_Result_kernel_and_height_and_intensity.rds"
