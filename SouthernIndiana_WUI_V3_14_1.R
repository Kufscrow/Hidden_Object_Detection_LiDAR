...
om_other_result <- detect_house_after_ground_inv(ng_patch_om)
...
text1 <- "Results/4/SouthernIndiana_WUI_region14_csf_tracluster.rds"
text2 <- "Results/4/SouthernIndiana_WUI_region14_pmf_tracluster.rds"
text3 <- "Results/4/SouthernIndiana_WUI_region14_mcc_tracluster.rds"
text4 <- "Results/4/SouthernIndiana_WUI_region14_h(1,4)_om_tracluster.rds"
text5 <- "Results/4/SouthernIndiana_WUI_region14_ori_trancluster.rds"
