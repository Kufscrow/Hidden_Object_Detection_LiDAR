...
result.patch.osr <- readRDS("Results/4/WestLafayette_City_region1_OSR.rds")
...
osr_other_result <- detect_house_after_ground(ng_patch_osr)
...
text6 <- "Results/4/WestLafayette_City_region1_osr_trancluster.rds"
