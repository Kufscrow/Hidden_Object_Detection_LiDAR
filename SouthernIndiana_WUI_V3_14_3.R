...
result.patch.2[which(result.patch.2==3)] <- 1
...
result_mcc_5_1[which(las_patch_mcc$Classification!=2)] <- label_fix_GMM_nonground_1(GMM_cluster_whole_mcc_5_1, GMM_cluster_whole_mcc_Hessg_1)
result_ori_5_1[which(las.patch.base$Classification!=2)] <- label_fix_GMM_nonground_1(GMM_cluster_whole_ori_5_1, GMM_cluster_whole_ori_Hessg_1)
result_om_5_2[which(result.patch.2!=2)] <- label_fix_GMM_nonground_1(GMM_cluster_whole_om_5_2, GMM_cluster_whole_om_Hessg_2)
result_csf_5_2[which(las_patch_csf$Classification!=2)] <- label_fix_GMM_nonground_1(GMM_cluster_whole_csf_5_2, GMM_cluster_whole_csf_Hessg_2)
...
result_mcc_5_2[which(las_patch_mcc$Classification!=2)] <- label_fix_GMM_nonground_1(GMM_cluster_whole_mcc_5_2, GMM_cluster_whole_mcc_Hessg_2)
...
text6.1 <- "Results/4/SouthernIndiana_WUI_region14_h(1,4)_Result_sectored_kernel_only.rds"
text6.2 <- "Results/4/SouthernIndiana_WUI_region14_h(1,4)_Result_kernel_only.rds"
text6.3 <- "Results/4/SouthernIndiana_WUI_region14_h(1,4)_Result_sectored_kernel_only_and_height.rds"
text6.4 <- "Results/4/SouthernIndiana_WUI_region14_h(1,4)_Result_kernel_only_and_height.rds"
text6.5 <- "Results/4/SouthernIndiana_WUI_region14_h(1,4)_Result_sectored_kernel_only_intensity.rds"
text6.6 <- "Results/4/SouthernIndiana_WUI_region14_h(1,4)_Result_kernel_only_intensity.rds"
text6.7 <- "Results/4/SouthernIndiana_WUI_region14_h(1,4)_Result_sectored_kernel_only_intensity_and_height.rds"
text6.8 <- "Results/4/SouthernIndiana_WUI_region14_h(1,4)_Result_kernel_only_intensity_and_height.rds"

text7.1 <- "Results/4/SouthernIndiana_WUI_region14_CSF_sectored_kernel_only.rds"
text7.2 <- "Results/4/SouthernIndiana_WUI_region14_CSF_kernel_only.rds"
text7.3 <- "Results/4/SouthernIndiana_WUI_region14_CSF_sectored_kernel_only_and_height.rds"
text7.4 <- "Results/4/SouthernIndiana_WUI_region14_CSF_kernel_only_and_height.rds"
text7.5 <- "Results/4/SouthernIndiana_WUI_region14_CSF_sectored_kernel_only_intensity.rds"
text7.6 <- "Results/4/SouthernIndiana_WUI_region14_CSF_kernel_only_intensity.rds"
text7.7 <- "Results/4/SouthernIndiana_WUI_region14_CSF_sectored_kernel_only_intensity_and_height.rds"
text7.8 <- "Results/4/SouthernIndiana_WUI_region14_CSF_kernel_only_intensity_and_height.rds"

text8.1 <- "Results/4/SouthernIndiana_WUI_region14_PMF_sectored_kernel_only.rds"
text8.2 <- "Results/4/SouthernIndiana_WUI_region14_PMF_kernel_only.rds"
text8.3 <- "Results/4/SouthernIndiana_WUI_region14_PMF_sectored_kernel_only_and_height.rds"
text8.4 <- "Results/4/SouthernIndiana_WUI_region14_PMF_kernel_only_and_height.rds"
text8.5 <- "Results/4/SouthernIndiana_WUI_region14_PMF_sectored_kernel_only_intensity.rds"
text8.6 <- "Results/4/SouthernIndiana_WUI_region14_PMF_kernel_only_intensity.rds"
text8.7 <- "Results/4/SouthernIndiana_WUI_region14_PMF_sectored_kernel_only_intensity_and_height.rds"
text8.8 <- "Results/4/SouthernIndiana_WUI_region14_PMF_kernel_only_intensity_and_height.rds"

text9.1 <- "Results/4/SouthernIndiana_WUI_region14_MCC_sectored_kernel_only.rds"
text9.2 <- "Results/4/SouthernIndiana_WUI_region14_MCC_kernel_only.rds"
text9.3 <- "Results/4/SouthernIndiana_WUI_region14_MCC_sectored_kernel_only_and_height.rds"
text9.4 <- "Results/4/SouthernIndiana_WUI_region14_MCC_kernel_only_and_height.rds"
text9.5 <- "Results/4/SouthernIndiana_WUI_region14_MCC_sectored_kernel_only_intensity.rds"
text9.6 <- "Results/4/SouthernIndiana_WUI_region14_MCC_kernel_only_intensity.rds"
text9.7 <- "Results/4/SouthernIndiana_WUI_region14_MCC_sectored_kernel_only_intensity_and_height.rds"
text9.8 <- "Results/4/SouthernIndiana_WUI_region14_MCC_kernel_only_intensity_and_height.rds"

text10.1 <- "Results/4/SouthernIndiana_WUI_region14_ori_sectored_kernel_only.rds"
text10.2 <- "Results/4/SouthernIndiana_WUI_region14_ori_kernel_only.rds"
text10.3 <- "Results/4/SouthernIndiana_WUI_region14_ori_sectored_kernel_only_and_height.rds"
text10.4 <- "Results/4/SouthernIndiana_WUI_region14_ori_kernel_only_and_height.rds"
text10.5 <- "Results/4/SouthernIndiana_WUI_region14_ori_sectored_kernel_only_intensity.rds"
text10.6 <- "Results/4/SouthernIndiana_WUI_region14_ori_kernel_only_intensity.rds"
text10.7 <- "Results/4/SouthernIndiana_WUI_region14_ori_sectored_kernel_only_intensity_and_height.rds"
text10.8 <- "Results/4/SouthernIndiana_WUI_region14_ori_kernel_only_intensity_and_height.rds"
