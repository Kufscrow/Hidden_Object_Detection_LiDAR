...
text16.1 <- "Results/4/WestLafayette_City_region1_OSR_sectored_kernel_only.rds"
text16.2 <- "Results/4/WestLafayette_City_region1_OSR_kernel_only.rds"
text16.3 <- "Results/4/WestLafayette_City_region1_OSR_sectored_kernel_only_and_height.rds"
text16.4 <- "Results/4/WestLafayette_City_region1_OSR_kernel_only_and_height.rds"
text16.5 <- "Results/4/WestLafayette_City_region1_OSR_sectored_kernel_only_intensity.rds"
text16.6 <- "Results/4/WestLafayette_City_region1_OSR_kernel_only_intensity.rds"
text16.7 <- "Results/4/WestLafayette_City_region1_OSR_sectored_kernel_only_intensity_and_height.rds"
text16.8 <- "Results/4/WestLafayette_City_region1_OSR_kernel_only_intensity_and_height.rds"
